...
### Changed
- Removed 0.998 maximum limit on alpha parameter, diverging from original WGEN (Anderson) Fortran code to allow more flexible parameter calibration
- UI improvements to desktop application interface
