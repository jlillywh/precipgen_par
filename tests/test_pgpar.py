...
class TestPrecipGenPAR(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.expected_params = pd.DataFrame({
            ...
            'ALPHA': [1.120348, 1.066008, 0.982768, 0.914160, 0.891204, 0.867014, 0.839977, 0.831021, 0.830143, 0.861214, 0.965841, 0.983633],
            'BETA': [2.030726, 2.099219, 2.908405, 3.305968, 3.645938, 3.199876, 3.360819, 4.223135, 4.881152, 4.868470, 3.170488, 2.571250]
        })
