...
class TestTimeSeries(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.sample_csv_content = """STATION,NAME,LATITUDE,LONGITUDE,ELEVATION,DATE,PRCP,SNOW,SNWD,TMAX,TMIN
# Additional metadata line 1
# Additional metadata line 2
# Additional metadata line 3
# Additional metadata line 4
# Additional metadata line 5
USW00023066,GRAND JUNCTION REGIONAL AP,39.1224,-108.5267,1475.2,2020-01-01,0.00,0.0,0.0,5.0,-5.0
USW00023066,GRAND JUNCTION REGIONAL AP,39.1224,-108.5267,1475.2,2020-01-02,2.50,0.0,0.0,8.0,-2.0
USW00023066,GRAND JUNCTION REGIONAL AP,39.1224,-108.5267,1475.2,2020-01-03,0.00,0.0,0.0,10.0,0.0"""
...
class TestParameterCalculations(unittest.TestCase):
    ...
    def test_calculate_params_missing_columns(self):
        ...
        bad_data = pd.DataFrame({'TEMP': [20]}, index=pd.DatetimeIndex(['2020-01-01']))
