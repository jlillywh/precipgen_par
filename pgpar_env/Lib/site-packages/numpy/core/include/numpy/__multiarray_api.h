...
NPY_NO_EXPORT  int NpyIter_ResetBasePointers \
       (NpyIter *, char **, char **);
NPY_NO_EXPORT  int NpyIter_ResetToIterInderange \
...
NPY_NO_EXPORT  npy_intp NpyIter_GetIterSize \
       (NpyIter *);
NPY_NO_EXPORT  void NpyIter_GetIterInderange \
...
#define NpyIter_ResetBasePointers \
    ...
    PyArray_API[235])
#define NpyIter_ResetToIterInderange \
...
#define NpyIter_GetIterSize \
        (*(npy_intp (*)(NpyIter *)) \
    PyArray_API[240])
#define NpyIter_GetIterInderange \
